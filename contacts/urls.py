...
urlpatterns = [
    ...
    path('contact-list/', views.contacts_list, name='contacts_list'),
    ...
    path('edit_contact/<int:id>/', views.contacts_update, name='contacts_update'),
    path('contact/<int:id>/', views.contacts_view, name='contacts_view'),
